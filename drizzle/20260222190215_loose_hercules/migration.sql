...
CREATE TYPE "endgame" AS ENUM('L1', 'L2', 'L3', 'Failed', 'None');--> statement-breakpoint
...
CREATE TABLE "team_event" (
	...
	CONSTRAINT "team_event_key" UNIQUE("eventKey","teamKey")
);
--> statement-breakpoint
...
ALTER TABLE "team_match" ADD CONSTRAINT "team_match_eventKey_event_eventKey_fkey" FOREIGN KEY ("eventKey") REFERENCES "event"("eventKey");--> statement-breakpoint
